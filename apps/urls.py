...
urlpatterns = [
    ...
    path('master/promo/', views.promo_index, name='promo-index'),
    path('master/promo/add/', views.promo_add, name='promo-add'),
    path('master/promo/view/<str:_id>/',
         views.promo_view, name='promo-view'),
    path('master/promo/update/<str:_id>/',
         views.promo_update, name='promo-update'),
    path('master/promo/delete/<str:_id>/',
         views.promo_delete, name='promo-delete'),
    path('master/promo-detail/update/<str:_id>/',
         views.promo_detail_update, name='promo-detail-update'),
    path('master/promo-detail/delete/<str:_id>/',
         views.promo_detail_delete, name='promo-detail-delete'),
    ...
    path('master/goat-type/', views.goat_type_index, name='goat-type-index'),
    path('master/goat-type/add/', views.goat_type_add, name='goat-type-add'),
    path('master/goat-type/view/<str:_id>/',
         views.goat_type_view, name='goat-type-view'),
    path('master/goat-type/update/<str:_id>/', views.goat_type_update,
         name='goat-type-update'),
    path('master/goat-type/delete/<str:_id>/',
         views.goat_type_delete, name='goat-type-delete'),
    path('master/dashboard/', views.dashboard_card_index, name='dashboard-card-index'),
    path('master/dashboard/add/', views.dashboard_card_add, name='dashboard-card-add'),
    path('master/dashboard/view/<str:_id>/',
         views.dashboard_card_view, name='dashboard-card-view'),
    path('master/dashboard/update/<str:_id>/', views.dashboard_card_update,
         name='dashboard-card-update'),
    path('master/dashboard/delete/<str:_id>/',
         views.dashboard_card_delete, name='dashboard-card-delete'),
    ...
    path('master/package-beverage/<str:_id>/',
         views.package_beverage_view, name='package-beverage-view'),
    ...
    path('master/package-souvenir/<str:_id>/',
         views.package_souvenir_view, name='package-souvenirs-view'),
    path('master/package-other/<str:_id>/',
         views.package_other_view, name='package-other-view'),
    ...
    path('master/package-beverage/update/<str:_id>/<str:_eq>/',
         views.package_beverage_update, name='package-beverage-update'),
    ...
    path('master/package-souvenir/update/<str:_id>/<str:_eq>/',
         views.package_souvenir_update, name='package-souvenirs-update'),
    path('master/package-other/update/<str:_id>/<str:_eq>/',
         views.package_other_update, name='package-other-update'),
    ...
    path('master/package-beverage/delete/<str:_id>/<str:_eq>/',
         views.package_beverage_delete, name='package-beverage-delete'),
    ...
    path('master/package-souvenir/delete/<str:_id>/<str:_eq>/',
         views.package_souvenir_delete, name='package-souvenirs-delete'),
    path('master/package-other/delete/<str:_id>/<str:_eq>/',
         views.package_other_delete, name='package-other-delete'),
    ...
    path('order/archive/<str:_branch>/<str:_date>/',
         views.order_archive, name='order-archive'),
    path('order/<str:_branch>/<str:_date>/',
         views.order_index, name='order-index'),
    ...
    path('jadwal/', views.jadwal_index, name='jadwal-index'),
